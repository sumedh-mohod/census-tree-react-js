        ...
        <Card variant="outlined" style={{ padding: '20px', margin: 10, boxShadow: 'none' }}>
          ...
          <Container>
            <>
              ...
              <p>Last updated: October 06, 2022</p>
              ...
              <ul>
                <li>
                  <p>
                    ...
                    any electronic device, named Tree Survey Master
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    ...
                    Agreement) refers to Abell Electro-Soft Technologies Pvt. Ltd., Prabhavee Tech Park, Regus, Fourth
                    Floor, Baner, Pune, Maharashtra 411045.
                  </p>
                </li>
                <li>
                  <p>
              ...
              <ul>
                <li>By email: abellelectrosoft@gmail.com</li>
              </ul>
            </>
          </Container>
        </Card>
