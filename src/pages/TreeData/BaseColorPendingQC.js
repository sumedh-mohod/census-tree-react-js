...
import {
 ...
 import { GetBaseColorPendingQCStatus } from '../../actions/BaseColorAction';
 ...
 import Page from '../../components/Page';
  ...
  export default function BaseColorPendingQC(){
    ...
    console.log("in base c pending");
    console.log(baseColorPendingQCStatus);
    useEffect(()=>{
  ...
  //     ));
    ...
    //   },baseColorPendingQCStatus.data[0].id))
    // }

    // const handleApproveNext = () =>{
    //   dispatch(UpdateQCStatusOfTreeCensus(baseColorPendingQCStatus.data[0].id,{
    //     "qc_status" : "Approved"
    //   }))
    // }
    ...
    const handleAddedByChange = (event) => {
      ...
      const formik = useFormik({
        ...
        onSubmit: (value) => {
          ...
          dispatch(baseColorPendingQCStatus(councilID,zoneID,wardID, value.fromDateForm, value.toDateForm));
        },
      });
  ...
  <Box sx={{ height: 400, width: '100%' }}>
    ...
    <Typography variant="h4" gutterBottom>
          ...
          {baseColorPendingQCStatus.data?(
            <>
          <table>
             <tr>
             <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Tree Number:</td>
             <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}> {baseColorPendingQCStatus.data[0].tree_number}</td>
             </tr>
            
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Tree Name: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].tree_name?.name}</td>
            </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Botanical Name: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].tree_name?.botanical_name}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Tree Type: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].tree_type.tree_type}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Location Type: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].location_type.location_type}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Property Type: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].property_type? baseColorPendingQCStatus.data[0].property_type.property_type: "-"}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Property Number: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].property?.property_number?baseColorPendingQCStatus.data[0].property?.property_number:"-"}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Owner Name: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].property?.owner_name}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Tenant Name: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].property?.tenant_name}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Area(Sq feet): </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].property?.area? baseColorPendingQCStatus.data[0].property.area:"-"}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Plantation Date: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].plantation_date}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Tree Condition: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].tree_condition.condition}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Girth: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].girth}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Height: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].height}</td>
              </tr>
             <tr>
              <td style={{fontWeight:700, textAlign: "left",  padding: "10px"}}>Canopy: </td>
              <td style={{fontWeight:400, textAlign: "left",  padding: "10px"}}>{baseColorPendingQCStatus.data[0].canopy}</td>
              </tr>
             </table>
             </>
             ):null}
  ...
  <Button size="small" >Approve & Next</Button>
...
{updateClick?  
        ...
        data={baseColorPendingQCStatus.data[0]}
        />: null 
        }
    </Box>
